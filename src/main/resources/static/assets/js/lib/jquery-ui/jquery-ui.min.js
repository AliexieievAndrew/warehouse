...
(function (e) {
    ...
    function t(t, s) {
        var n, a, o, r = t.nodeName.toLowerCase();DatePicker
    ...
    e(document).mouseup(function () {
        ...
        e.position = {
            ...
            n = e.extend({}, n);
            var p, m, g, v, b, y, _ = e(n.of), x = e.position.getWithinInfo(n.within), w = e.position.getScrollInfo(x),
            ...
            return y = s(_), _[0].preventDefault && (n.at = "left top"), m = y.width, g = y.height, v = y.offset, b = e.extend({}, v), e.each(["my", "at"], function () {
                ...
                var s, l, u = e(this), c = u.outerWidth(), d = u.outerHeight(), f = i(this, "marginLeft"),
                    y = i(this, "marginTop"), D = c + f + i(this, "marginRight") + w.width,
                    S = d + y + i(this, "marginBottom") + w.height, N = e.extend({}, b),
                    M = t(T.my, u.outerWidth(), u.outerHeight());
                "right" === n.my[0] ? N.left -= c : "center" === n.my[0] && (N.left -= c / 2), "bottom" === n.my[1] ? N.top -= d : "center" === n.my[1] && (N.top -= d / 2), N.left += M[0], N.top += M[1], a || (N.left = h(N.left), N.top = h(N.top)), s = {
                    marginLeft: f,
                    marginTop: y
                    ...
                    var t = v.left - N.left, i = t + m - c, s = v.top - N.top, a = s + g - d, h = {
                        target: {element: _, left: v.left, top: v.top, width: m, height: g},
                        element: {element: u, left: N.left, top: N.top, width: c, height: d},
            ...
            fit: {
                ...
                left: function (e, t) {
                    var i, s, n = t.within, a = n.offset.left + n.scrollLeft, o = n.width,
                        ...
                        u = l - h, c = l + t.collisionWidth - o - h,
                    ...
                    var i, s, n = t.within, a = n.offset.top + n.scrollTop, o = n.height,
                        ...
                        u = l - h, c = l + t.collisionHeight - o - h, d = "top" === t.my[1],
        ...
        start: function (t, i, s) {
            ...
            var n, a, o, r, h, l, u, c, d, p, f = s.options, m = f.snapTolerance, g = i.offset.left,
            ...
            for (d = s.snapElements.length - 1; d >= 0; d--) h = s.snapElements[d].left - s.margins.left, l = h + s.snapElements[d].width, u = s.snapElements[d].top - s.margins.top, c = u + s.snapElements[d].height, h - m > v || g > l + m || u - m > y || b > c + m || !e.contains(s.snapElements[d].item.ownerDocument, s.snapElements[d].item) ? (s.snapElements[d].snapping && s.options.snap.release && s.options.snap.release.call(s.element, t, e.extend(s._uiHash(), {snapItem: s.snapElements[d].item})), s.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (n = m >= Math.abs(u - y), a = m >= Math.abs(c - b), o = m >= Math.abs(h - v), r = m >= Math.abs(l - g), n && (i.position.top = s._convertPositionTo("relative", {
                ...
                top: 0,
                left: l
            }).left)), p = n || a || o || r, "outer" !== f.snapMode && (n = m >= Math.abs(u - b), a = m >= Math.abs(c - y), o = m >= Math.abs(h - g), r = m >= Math.abs(l - v), n && (i.position.top = s._convertPositionTo("relative", {
                top: u,
                left: 0
            }).top), a && (i.position.top = s._convertPositionTo("relative", {
            ...
            }).left)), !s.snapElements[d].snapping && (n || a || o || r || p) && s.options.snap.snap && s.options.snap.snap.call(s.element, t, e.extend(s._uiHash(), {snapItem: s.snapElements[d].item})), s.snapElements[d].snapping = n || a || o || r || p)
        }
        ...
        start: function () {
            var t, i, s, n, a, o, r, h = e(this).resizable("instance"), l = h.options, u = h.element, c = l.containment,
            ...
            var i, s, n, a, o = e(this).resizable("instance"), r = o.options, h = o.containerOffset, l = o.position,
                u = o._aspectRatio || t.shiftKey, c = {top: 0, left: 0}, d = o.containerElement, p = !0;
        ...
        resize: function () {
            var t, i = e(this).resizable("instance"), s = i.options, n = i.size, a = i.originalSize,
                ...
                l = h[0] || 1, u = h[1] || 1, c = Math.round((n.width - a.width) / l) * l,
                d = Math.round((n.height - a.height) / u) * u, p = a.width + c, f = a.height + d,
        ...
        _intersectsWith: function (e) {
            var t = this.positionAbs.left, i = t + this.helperProportions.width, s = this.positionAbs.top,
                ...
                d = "y" === this.options.axis || t + u > a && o > t + u, p = c && d;
        ...
        _refreshItems: function (t) {
            ...
            var i, s, n, a, o, r, h, l, u = this.items,
                ...
                d = this._connectWith();
            if (d && this.ready) for (i = d.length - 1; i >= 0; i--) for (n = e(d[i], this.document[0]), s = n.length - 1; s >= 0; s--) a = e.data(n[s], this.widgetFullName), a && a !== this && !a.options.disabled && (c.push([e.isFunction(a.options.items) ? a.options.items.call(a.element[0], t, {item: this.currentItem}) : e(a.options.items, a.element), a]), this.containers.push(a));
        ...
        _contactContainers: function (t) {
            ...
            if (d) if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger("over", t, this._uiHash(this)), this.containers[p].containerCache.over = 1); else {
    ...
    e.effects = {effect: {}}, function (e, t) {
        ...
        p.style.cssText = "background-color:rgba(1,1,1,.5)", d.rgba = p.style.backgroundColor.indexOf("rgba") > -1, f(u, function (e, t) {
            ...
            var t, i, s = e[0] / 255, n = e[1] / 255, a = e[2] / 255, o = e[3], r = Math.max(s, n, a),
                h = Math.min(s, n, a), l = r - h, u = r + h, c = .5 * u;
        ...
        var s, n, a, o = e(this), r = /up|down|vertical/, h = /up|left|vertical|horizontal/,
            ...
            u = e.effects.setMode(o, t.mode || "hide"), c = t.direction || "up", d = r.test(c),
            p = d ? "height" : "width", f = d ? "top" : "left", m = h.test(c), g = {}, v = "show" === u;
        o.parent().is(".ui-effects-wrapper") ? e.effects.save(o.parent(), l) : e.effects.save(o, l), o.show(), s = e.effects.createWrapper(o).css({overflow: "hidden"}), n = s[p](), a = parseFloat(s.css(f)) || 0, g[p] = v ? n : 0, m || (o.css(d ? "bottom" : "right", 0).css(d ? "top" : "left", "auto").css({position: "absolute"}), g[f] = v ? a : n + a), v && (s.css(p, 0), m || s.css(f, a + n)), s.animate(g, {
            duration: t.duration,
            easing: t.easing,
            queue: !1,
            complete: function () {
        ...
        var s, n, a, o = e(this), r = ["position", "top", "bottom", "left", "right", "height", "width"],
            h = e.effects.setMode(o, t.mode || "effect"), l = "hide" === h, u = "show" === h, c = t.direction || "up",
            d = t.distance, p = t.times || 5, f = 2 * p + (u || l ? 1 : 0), m = t.duration / f, g = t.easing,
            v = "up" === c || "down" === c ? "top" : "left", b = "up" === c || "left" === c, y = o.queue(),
            _ = y.length;
        for ((u || l) && r.push("opacity"), e.effects.save(o, r), o.show(), e.effects.createWrapper(o), d || (d = o["top" === v ? "outerHeight" : "outerWidth"]() / 3), u && (a = {opacity: 1}, a[v] = 0, o.css("opacity", 0).css(v, b ? 2 * -d : 2 * d).animate(a, m, g)), l && (d /= Math.pow(2, p - 1)), a = {}, a[v] = 0, s = 0; p > s; s++) n = {}, n[v] = (b ? "-=" : "+=") + d, o.animate(n, m, g).animate(a, m, g), d = l ? 2 * d : d / 2;
        l && (n = {opacity: 0}, n[v] = (b ? "-=" : "+=") + d, o.animate(n, m, g)), o.queue(function () {
        ...
        var s, n, a, o = e(this), r = ["position", "top", "bottom", "left", "right", "height", "width"],
            ...
            c = "vertical" === u, d = c ? "height" : "width", p = c ? "top" : "left", f = {};
        ...
        var a, o, r, h, l, u, c = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, d = c, p = e(this),
            f = e.effects.setMode(p, t.mode || "hide"), m = "show" === f,
            g = p.show().css("visibility", "hidden").offset(), v = Math.ceil(p.outerWidth() / d),
            b = Math.ceil(p.outerHeight() / c), y = [];
        for (a = 0; c > a; a++) for (h = g.top + a * b, u = a - (c - 1) / 2, o = 0; d > o; o++) r = g.left + o * v, l = o - (d - 1) / 2, p.clone().appendTo("body").wrap("<div></div>").css({
            position: "absolute",
            visibility: "visible",
            left: -o * v,
            top: -a * b
        ...
        var s, n, a = e(this), o = ["position", "top", "bottom", "left", "right", "height", "width"],
            ...
            c = /([0-9]+)%/.exec(u), d = !!t.horizFirst, p = h !== d, f = p ? ["width", "height"] : ["height", "width"],
            m = t.duration / 2, g = {}, v = {};
        ...
        var s, n, a, o = e(this),
            ...
            g = t.origin || ["middle", "center"], v = o.css("position"), b = f ? r : h,
        ...
        var s, n = e(this), a = e.effects.setMode(n, t.mode || "show"), o = "show" === a, r = "hide" === a,
            h = o || "hide" === a, l = 2 * (t.times || 5) + (h ? 1 : 0), u = t.duration / l, c = 0, d = n.queue(),
            p = d.length;
        ...
        var s, n = e(this), a = ["position", "top", "bottom", "left", "right", "height", "width"],
            ...
            l = t.times || 3, u = 2 * l + 1, c = Math.round(t.duration / u),
        ...
        var s, n = e(this), a = ["position", "top", "bottom", "left", "right", "width", "height"],
            ...
            l = "up" === h || "down" === h ? "top" : "left", u = "up" === h || "left" === h, c = {};
        ...
        var s = e(this), n = e(t.to), a = "fixed" === n.css("position"), o = e("body"), r = a ? o.scrollTop() : 0,
            ...
            u = {top: l.top - r, left: l.left - h, height: n.innerHeight(), width: n.innerWidth()}, c = s.offset(),
